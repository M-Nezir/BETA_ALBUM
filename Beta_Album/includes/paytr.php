...
$merchant_ok_url = "https://www.siteniz.com/success.php";
$merchant_fail_url = "https://www.siteniz.com/fail.php";
...
//      $card_type = "bonus";       // Alabileceği değerler; advantage, axess, combo, bonus, cardfinans, maximum, paraf, world, saglamkart
      $installment_count = "0";
        ...
        $hash_str = $merchant_id .$user_ip .$merchant_oid .$email .$payment_amount .$payment_type ."0" ."1" ."1" .$currency .$test_mode .$non_3d ."tr";
